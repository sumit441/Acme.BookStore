...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3b3e6a82-3156-4c06-931a-d2cb7e9a160f
```

> `3b3e6a82-3156-4c06-931a-d2cb7e9a160f` is the password of the certificate, you can change it to any password you want.
